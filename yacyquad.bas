...
SELECT CASE client_method(c)
    ...
    CASE METHOD_GET
        ...
        m$ = m$ + "src" + CHR$(61) + "" + CHR$(34) + "http" + CHR$(58) + "" + CHR$(47) + "" + CHR$(47) + "sw" + CHR$(46) + "undo" + CHR$(46) + "it" + CHR$(58) + "8095" + CHR$(47) + "yacyinteractive" + CHR$(46) + "html" + CHR$(63) + "display" + CHR$(61) + "2" + CHR$(34) + ""
